...
const { createUseradmin, getAllUsers, getUserById, updateUser, deleteUser, buyMembership, deleteUserWithReason, upgradeMembership, cancelMembership, createScamReport, getScamReports, getScamBook, podcastSubscribe, contactQuery, searchProfile, viewProfile, userViewProfile, bookmarkProfile, getBookmarkData, getRecommendedData, recommendUser, downgradeMembership, nextPayment, userScamReport, deleteReport, dashboardData, purchaseHistory, getRatingReceivedData, getRatingGivenData, getGivenFeedback, giveFeedback, getMyGivenFeedback, sendMsg, getMsg, myChats, addBilling, getAllBilling, getProfileData, getListingUser, getTopProviders, disputeQuery, getDisputeQuery, bespokeRequestQuery, sendBasket, getRequestServiceQuery, subscribeNeswsletter, inviteUserEmail, connectionRequest, connectionAction, disputePayment, requestPayment, getLiveAd, readMessage, getNotifications, deleteNotifications, getAdProvider, blogSubscribe } = require('../controllers/user.controller');
...
const { searchProviders, getProviderLocations } = require('../controllers/user.controller');
...
router.get('/listing-provider',  getListingUser)
...
router.post('/subscribe-blog', blogSubscribe);
...
router.delete('/notification/:id',authMiddleware, deleteNotifications);

router.get('/provider-locations', getProviderLocations);
